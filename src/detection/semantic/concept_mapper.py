...
ONTOLOGY: Tuple[ConceptRule, ...] = (
    ...
    ConceptRule("employee of the month", ("employee of the month", "recognition", "award", "kudos", "monthly award"), "list"),
    ConceptRule("employee of month",    ("employee of the month", "recognition", "award", "kudos"),                  "list"),
    ConceptRule("monthly award",        ("award", "recognition", "employee of the month", "monthly"),                "list"),
    ConceptRule("best employee",        ("recognition", "award", "employee of the month", "kudos"),                  "list"),
    ConceptRule("star performer",       ("recognition", "award", "performance", "star"),                             "list"),
    ConceptRule("top performer",        ("recognition", "award", "performance", "top"),                              "list"),
